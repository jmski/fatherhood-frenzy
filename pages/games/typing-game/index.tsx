...
import Result from "../../../components/games/typing-game/Result";
import Test from "../../../components/games/typing-game/Test";
import Header from "../../../components/games/typing-game/Header";
import Footer from "../../../components/games/typing-game/Footer";
...
export default class TypeTest extends Component<{}, State> {
  ...
  recordTest = (e: KeyboardEvent) => {
    const { typedWord, currWord, timer, timeLimit, setTimer, typedHistory } =
      this.state;
    if (timer === 0) {
      if (e.key === "Tab") {
        this.resetTest();
      ...
      case "Backspace":
        if (
          ...
          this.setState({
            ...
            typedHistory: typedHistory.splice(0, typedHistory.length - 1),
          });
